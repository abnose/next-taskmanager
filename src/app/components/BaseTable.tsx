...
export default function BaseTable({
  ...
  return (
    <Box
      dir="rtl"
      className="overflow-x-auto border-2 border-gray-100 sm:rounded-lg relative"
    >
      <table
        className="w-full text-sm dark:bg-white text-left rtl:text-right text-gray-800 dark:text-gray-400"
        width="100%"
      >
        <thead className="text-lg text-gray-700 shadow-md bg-gray-50 dark:bg-gray-100 dark:text-black">
          <tr>
        ...
        <thead className="text-xs h-[50px] text-gray-700 border-b-2 dark:border-gray-100">
          <tr>
      ...
      {pagination && (
        <div className="flex justify-center items-center dark:bg-gray-100 w-full text-gray-800 p-2">
          <Pagination
